 ...
 * 30 + n |    m | Extra field
 */
export const LocalFileHeaderToken: IGetToken<ILocalFileHeader> = {
 ...
 */
export const EndOfCentralDirectoryRecordToken: IGetToken<IEndOfCentralDirectoryRecord> = {
 ...
 */
export const FileHeader: IGetToken<IFileHeader> = {
